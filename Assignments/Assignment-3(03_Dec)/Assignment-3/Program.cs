...
//        {
//            Manager o = new Manager("Sandy", 10, 18000, "GM");
//            Console.WriteLine(o.EMPNO + " " + o.NAME + " " + o.DEPTNO + " " + o.BASIC + " " + o.DESIGNATION + " " + o.calcNetSalary());
//            Console.ReadLine();
...
//        public Manager(string name = "NoName", short deptNo = 01, decimal basic = 10000, string designation = "GM")
//        {
//            this.NAME = name;
//            this.DEPTNO = deptNo;
//            this.BASIC = basic;
